...
/* Style photo imprimée */

.photo {
  border: 1px solid #D0D0D0; /* Ajouter une bordure pleine */
  width: 14rem;
  height: 15rem;
  background: #ffffff;
  padding-top: 1rem;
  ...
  padding-right: 1rem;
  padding-bottom: 3rem;
  box-shadow: 8px 8px 10px 4px #888888; /* ombre, flou, étalement et couleur à droite et en bas */
